...
- **Gera links de afiliado automaticamente para Amazon BR** (`?tag=brunoentende-20`)
...
- `scripts/fetch_mercadolivre_br.py` — Fetcher Mercado Livre (extrai preco atual + preco anterior)
...
- Mercado Livre ainda nao gera links de afiliado (pendente implementacao).
